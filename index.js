const data = [
  {
    name: [
      `<ul>
          ...
          <li><a href="task-1.html">Перейти на страницу выполнения задания</a></li>
        </ul>`
    ],
  },
  {
    name: [
      `<ul>
          ...
          <li><a href="task-2.html">Перейти на сторінку виконання завдання</a></li>
        </ul>`
    ],
  },
  {
    name: [
      `<ul>
          ...
          <li><a href="task-3.html">Перейти на сторінку виконання завдання</a></li>
        </ul>`
    ],
  },
  {
    name: [
      `<ul>
          ...
          <li><a href="task-4.html">Перейти на сторінку виконання завдання</a></li>
        </ul>`
    ],
  },
  {
    name: [
      `<ul>
          ...
          <li><a href="task-5.html">Перейти на сторінку виконання завдання</a></li>
        </ul>`
    ],
  },
  {
...
элементы в DOM.</li>
          ...
          <li><a href="task-6.html">Перейти на сторінку виконання завдання</a></li>
        </ul>`
    ],
  },
];
